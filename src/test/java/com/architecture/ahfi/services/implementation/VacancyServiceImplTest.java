...
//        return Stream.of(
//                Arguments.of(Arrays.asList(null, null, "Lviv", null, null, 0), Arrays.asList(new Vacancy(9, "Java job for Vitalik", false, 10000, new Company(1, "ahfi"), new Category(1, "IT"), "test", LocalDate.parse("2022-10-30"), "Lviv", 10), new Vacancy(8, "Java job for Vitalik", false, 15000, new Company(2, "test"), new Category(2, "Finance"), "test", LocalDate.parse("2020-10-15"), "Lviv", 10))),
//                Arguments.of(Arrays.asList("a", 11, "Lviv", null, 11111, 1), Arrays.asList(new Vacancy(8, "Java job for Vitalik", false, 15000, new Company(2, "test"), new Category(2, "Finance"), "test", LocalDate.parse("2020-10-15"), "Lviv", 10))),
...
//        return Stream.of(
//                Arguments.of(new Vacancy(2, "Java job for Vitalik", false, 15000, new Company(2, "test"), new Category(2, "Finance"), "test", LocalDate.parse("2020-10-15"), "Lviv", 10)),
//                Arguments.of(new Vacancy(1, "Java job for Vitalik", false, 10000, new Company(1, "ahfi"), new Category(1, "IT"), "test", LocalDate.parse("2022-10-30"), "Lviv", 10)),
//                Arguments.of(new Vacancy(5, "Java job for Vitalik", false, 10000, new Company(1, "ahfi"), new Category(1, "IT"), "test", LocalDate.parse("2022-10-30"), "Lviv", 10)),
//                Arguments.of(new Vacancy(6, "Java job for Vitalik", false, 10000, new Company(1, "ahfi"), new Category(1, "IT"), "test", LocalDate.parse("2022-10-30"), "Lviv", 10)),
//                Arguments.of(new Vacancy(7, "Java job for Vitalik", false, 10000, new Company(1, "ahfi"), new Category(1, "IT"), "test", LocalDate.parse("2022-10-30"), "Lviv", 10))
//
//        );
//    }
//
...
//        List<Vacancy> vacancyList = service.filter(filters);
